...
class SearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.searchEditText.addTextChangedListener(object: TextWatcher
        {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                if (view.searchEditText.text.toString() == "")
                {
    ...
    {
        val query = FirebaseDatabase.getInstance("https://speedtest-b22c2-default-rtdb.europe-west1.firebasedatabase.app").getReference()
            .child("Users")
        ...
        query.addValueEventListener(object: ValueEventListener
        {
            override fun onDataChange(dataSnapsot: DataSnapshot)
            {
                ...
                for (snapshot in dataSnapsot.children)
                {
